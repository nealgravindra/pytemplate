...
- 🐛 Typechecking with [Ty](https://github.com/astral-sh/ty).
- 🔊 Application logging pre-wired with [Loguru](https://github.com/Delgan/loguru).
...
- 🧙‍♂️ Semantic Pull Requests - Enforce pull request titles
